...
def main():
    # Front end Elements:
    html_temp = """
    <div style ="background: linear-gradient(to bottom, #9966ff 0%, #cc00cc 100%);padding:13px">
    <h1 style ="color:#000099;text-align:center;">Kickstarter Project Success Prediction ML App</h1>
    </div>
    """
